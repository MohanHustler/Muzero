...
import StudentAssessments from '../components/layouts/student_assessments';

interface Props extends RouteComponentProps<{ username: string }> {
  authUser: User;
}

const ProfileAssessments: FunctionComponent<Props> = ({ authUser }) => {
  ...
  return <StudentAssessments profile={authUser as Student} />;
};
...
export default connect(mapStateToProps)(withRouter(ProfileAssessments));
